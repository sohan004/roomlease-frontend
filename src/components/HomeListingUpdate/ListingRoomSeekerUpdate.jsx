                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 lg:grid-cols-4 text-center font-medium">
                                ...
                                <p onClick={() => setHouseType('Townhouse')} className={`font-bold text-[#7065F0] border duration-500 ${houseType === 'Townhouse' ? 'hover:bg-[#554db3] bg-[#706?0] text-white ' : 'bg-white hover:bg-indigo-100'} border-[#7065F0] py-3 cursor-pointer text-xs lg:text-base`}>Townhouse</p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 text-center font-medium">
                                ...
                                <p onClick={() => placeFriendFunction('None')} className={`border border-t-0 col-span-2 duration-500 ${placeFriendless.find(p => p == 'None') ? ' border border-[#bab7e4]  hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'} border-[#7065F0] text-[#7065F0] font-bold py-3 cursor-pointer text-xs lg:text-base `}>None</p>
                            </div>
                        </div>
                    </div>
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 lg:grid-cols-3 text-center font-medium">
                                ...
                                <p onClick={() => publicAddFunction('None')} className={`duration-500 border border-s-0 ${publicTransportAccess.find(p => p == 'None') ? 'border border-[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'} border-[#7065F0] text-[#7065F0] font-bold py-3 cursor-pointer text-xs lg:text-base`}>None</p>
                            </div>
                        </div>
                    </div>
