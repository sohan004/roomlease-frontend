        ...
        <>
            ...
            <div className='my-4 pb-6 border-b flex flex-col gap-4'>
                ...
                <div className="grid gap-2 grid-cols-2 text-xs lg:grid-cols-5 text-center font-medium">
                    ...
                    <p onClick={() => setParkingOptions('of Street')} className={`border-[#7065f0] rounded-md border  duration-500 ${parkingOptions === 'of Street' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'} border-[#7065f0] rounded-md border -[#7065F0] text-[#7065F0] font-bold py-3  cursor-pointer`}>of Street</p>
            ...
            <div className='my-4 pb-6 border-b flex flex-col gap-4'>
                ...
                <div className=" grid gap-2 grid-cols-2 lg:grid-cols-6 text-center font-medium">
                    ...
                    <p onClick={() => { ageFunction('46 - 60'); }} className={`duration-500 col-span-2 lg:col-span-1 border-[#7065f0] rounded-md border  border-[#7065f0] rounded-md border -t-0 lg:border-[#7065f0] rounded-md border -t lg:border-[#7065f0] rounded-md border -s-0  ${selectedAge.find(g => g == '46 - 60') ? 'border-[#7065f0] rounded-md border  border-[#7065f0] rounded-md border -[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065f0] rounded-md border -[#7065F0] text-[#7065F0] font-bold py-3  cursor-pointer text-xs `}>46 - 60</p>
                    <p onClick={() => { ageFunction('61+'); }} className={`duration-500 col-span-2 lg:col-span-1 border-[#7065f0] rounded-md border  border-[#7065f0] rounded-md border -t-0 lg:border-[#7065f0] rounded-md border -t lg:border-[#7065f0] rounded-md border -s-0  ${selectedAge.find(g => g == '61+') ? 'border-[#7065f0] rounded-md border  border-[#7065f0] rounded-md border -[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065f0] rounded-md border -[#7065F0] text-[#7065F0] font-bold py-3  cursor-pointer text-xs `}>61+</p>
                </div>
            </div>
            ...
            <div className='flex justify-center items-center gap-6  bg-white p-3 -bottom-8 lg:bottom-0 sticky w-full'>
                <button onClick={clickReset} className='btn bg-gray-200 border-[#7065f0] rounded-md border-0 text-[#7065F0]  flex-grow'>Reset</button>
                <button onClick={clickApply} className='btn bg-[#7065F0] border-[#7065f0] rounded-md border-0 hover:bg-[#3f3981] text-white flex-grow '>Apply</button>
            </div>
        </>
    );
};
