            ...
            <form onSubmit={handle} >
                <div className="p-4 border-2 lg:p-6  rounded-lg">
                    {!listing && <div className="grid grid-cols-1 lg:grid-cols-2 gap-6  ">
                        <div>
                            <input onChange={(e) => { setFirstName(e.target.value) }} placeholder="First Name" type="text" name="" className="w-full py-3 rounded-md bg-white px-4 border hover:border-2 focus:border-2 focus:bg-[#f8f8fc] focus:outline-none border-[#7065F0]  rounded-lg" />
                        </div>
                        <div>
                            <input onChange={(e) => { setSecondName(e.target.value) }} placeholder="Last Name" type="text" name="" className="w-full py-3 rounded-md px-4  bg-white hover:border-2 focus:border-2 border focus:bg-[#f8f8fc] focus:outline-none border-[#7065F0]  rounded-lg" />
                        </div>
                        <div className="col-span-1 lg:col-span-2 ">
                            <input onChange={(e) => { setEmail(e.target.value) }} placeholder="Email" type="email" name="" className="w-full py-3 rounded-md px-4  bg-white  hover:border-2 focus:border-2 border focus:bg-[#f8f8fc] focus:outline-none border-[#7065F0]  rounded-lg" />
                        </div>
                    </div>}
                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        {/* <div>
                            ...
                            <Autocomplete
                                ...
                                className="w-full mt-4 hover:border-2 focus:border-2 py-3 rounded-md px-4 border focus:outline-none focus:bg-[#f6f6ff] border-[#7065F0] rounded-lg"
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 lg:grid-cols-4 text-center font-medium">
                                ...
                                <p onClick={() => { setHouseType('Townhouse'); onchengeFunction() }} className={`font-bold text-[#7065F0] border duration-500 ${houseType === 'Townhouse' ? 'hover:bg-[#554db3] bg-[#706?0] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] py-3 rounded-md cursor-pointer text-xs lg:text-base`}>Townhouse</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 lg:grid-cols-5 text-center font-medium">
                                <p onClick={() => { setParkingOptions('Garage'); onchengeFunction() }} className={`border border-b-0 lg:border-b duration-500 ${parkingOptions === 'Garage' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>Garage</p>
                                <p onClick={() => { setParkingOptions('Driveway'); onchengeFunction() }} className={`border-t border-e lg:border-e-0 lg:border-y duration-500 ${parkingOptions === 'Driveway' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base `}>Driveway</p>
                                <p onClick={() => { setParkingOptions('On Street'); onchengeFunction() }} className={`border-y border-s duration-500 ${parkingOptions === 'On Street' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>On Street</p>
                                <p onClick={() => { setParkingOptions('of Street'); onchengeFunction() }} className={`border duration-500 ${parkingOptions === 'of Street' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>of Street</p>
                                <p onClick={() => { setParkingOptions('No Parking'); onchengeFunction() }} className={`duration-500 col-span-2 lg:col-span-1 border border-t-0 lg:border-t lg:border-s-0  ${parkingOptions === 'No Parking' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>No Parking</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        <div className="w-full">
                            ...
                            <DatePicker
                                className="mt-4 py-3 rounded-md px-4 border bg-white hover:border-2 focus:border-2 focus:bg-[#f7f6ff] border-[#7065F0] hover:outline-none w-full rounded-lg"
                                showIcon
                                selected={startDate}
                        ...
                        <div>
                            ...
                            {!maximumStayOthers && <div className="mt-4 grid gap-y-1 grid-cols-3 lg:grid-cols-6 text-center font-medium">
                                {maximumStayArray.map((item, index) =>
                                    <p key={index} onClick={() => { setMaximumStay(item.name); onchengeFunction() }} className={` duration-500 h-full border ${maximumStay === item.name ? 'hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>{item.name}</p>)}
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-3  text-center font-medium">
                                <p onClick={() => { setBond('2 weeks'); onchengeFunction() }} className={` duration-500 border ${bond === '2 weeks' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>2 weeks</p>
                                <p onClick={() => { setBond('1 month'); onchengeFunction() }} className={` duration-500 border-y border-e ${bond === '1 month' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>1 month</p>
                                <p onClick={() => { setBond('No bond'); onchengeFunction() }} className={` duration-500 border-y border-e ${bond === 'No bond' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>No bond</p>
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2  text-center font-medium">
                                <p onClick={() => setBillRent('yes')} className={`border  duration-500 ${billRent === 'yes' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>Yes</p>
                                <p onClick={() => setBillRent('no')} className={`border border-s-0 duration-500 
                            ${billRent == 'no' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base `}>No</p>
                            </div>
                            {billRent == 'no' &&
                                <div className="form-control mt-4 border-[#7065F0] border hover:border-2 focus:border-2 rounded-lg">
                                    <label className="input-group">
                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 text-center font-medium">
                                ...
                                <p onClick={() => { placeFriendFunction('N/A'); onchengeFunction() }} className={`border border-t-0 col-span-2 duration-500 ${placeFriendless.find(p => p == 'N/A') ? ' border border-[#bab7e4]  hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base `}>N/A</p>
                            </div>
                        </div>
                    </div>
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 lg:grid-cols-3 text-center font-medium">
                                ...
                                <p onClick={() => { publicAddFunction('N/A'); onchengeFunction() }} className={`duration-500 border border-s-0 ${publicTransportAccess.find(p => p == 'N/A') ? 'border border-[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>N/A</p>
                            </div>
                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 lg:grid-cols-6 text-center font-medium">
                                <p onClick={() => { ageFunction('Any'); onchengeFunction() }} className={`border border-b-0 lg:border-b duration-500 ${age.find(g => g == 'Any') ? 'border border-[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>Any</p>
                                <p onClick={() => { ageFunction('18 - 25'); onchengeFunction() }} className={`border-t border-e lg:border-e-0 lg:border-y duration-500 ${age.find(g => g == '18 - 25') ? 'border border-[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base `}>18 - 25</p>
                                <p onClick={() => { ageFunction('26 - 35'); onchengeFunction() }} className={`border-y border-s duration-500 ${age.find(g => g == '26 - 35') ? 'border border-[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>26 - 35</p>
                                <p onClick={() => { ageFunction('36 - 45'); onchengeFunction() }} className={`border duration-500 ${age.find(g => g == '36 - 45') ? 'border border-[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>36 - 45</p>
                                <p onClick={() => { ageFunction('46 - 60'); onchengeFunction() }} className={`duration-500 col-span-2 lg:col-span-1 border border-t-0 lg:border-t lg:border-s-0  ${age.find(g => g == '46 - 60') ? 'border border-[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>46 - 60</p>
                                <p onClick={() => { ageFunction('61+'); onchengeFunction() }} className={`duration-500 col-span-2 lg:col-span-1 border border-t-0 lg:border-t lg:border-s-0  ${age.find(g => g == '61+') ? 'border border-[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>61+</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 lg:grid-cols-3 text-center font-medium">
                                ...
                                <p onClick={() => occuptionFunction('Backpackers')} className={` duration-500 border lg:border-t-0 border-s-0 lg:border-s lg:border-e-0 border-b-0 lg:border-b  ${occuption.find(o => o == 'Backpackers') ? 'hover:bg-[#554db3] border border-[#bab7e4] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>Backpackers</p>
                                <p onClick={() => occuptionFunction('On welfare')} className={` duration-500 border  ${occuption.find(o => o == 'On welfare') ? 'hover:bg-[#554db3] border border-[#bab7e4] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] text-[#7065F0] font-bold py-3 rounded-md cursor-pointer text-xs lg:text-base`}>On welfare</p>
