                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid gap-2 grid-cols-2 lg:grid-cols-5 text-center font-medium">
                                ...
                                <p onClick={() => { setParkingOptions('of Street'); onchengeFunction() }} className={`rounded-md border-[#7065F0] border  duration-500 ${parkingOptions === 'of Street' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'}  rounded-md border-[#7065F0] border -[#7065F0] text-[#7065F0] font-bold py-3  cursor-pointer text-xs lg:text-base`}>of Street</p>
                    ...
                    <div className="grid gap-2 grid-cols-1 gap-10 mt-5 ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid gap-2 grid-cols-2 lg:grid-cols-6 text-center font-medium">
                                ...
                                <p onClick={() => { ageFunction('46 - 60'); onchengeFunction() }} className={`duration-500 col-span-2 lg:col-span-1 border-[#7065F0] rounded-md border  border-[#7065F0] rounded-md border -t-0 lg:border-[#7065F0] rounded-md border -t lg:border-[#7065F0] rounded-md border -s-0  ${age.find(g => g == '46 - 60') ? 'border-[#7065F0] rounded-md border  border-[#7065F0] rounded-md border -[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] rounded-md border -[#7065F0] text-[#7065F0] font-bold py-3  cursor-pointer text-xs lg:text-base`}>46 - 60</p>
                                <p onClick={() => { ageFunction('61+'); onchengeFunction() }} className={`duration-500 col-span-2 lg:col-span-1 border-[#7065F0] rounded-md border  border-[#7065F0] rounded-md border -t-0 lg:border-[#7065F0] rounded-md border -t lg:border-[#7065F0] rounded-md border -s-0  ${age.find(g => g == '61+') ? 'border-[#7065F0] rounded-md border  border-[#7065F0] rounded-md border -[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'}  border-[#7065F0] rounded-md border -[#7065F0] text-[#7065F0] font-bold py-3  cursor-pointer text-xs lg:text-base`}>61+</p>
                            </div>
                        </div>
