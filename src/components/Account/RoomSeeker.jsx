                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 lg:grid-cols-4 text-center font-medium">
                                ...
                                <p onClick={() => { setHouseType('Townhouse'); onchengeFunction() }} className={`font-bold text-[#7065F0] border duration-500 ${houseType === 'Townhouse' ? 'hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'} border-[#7065F0] py-3 cursor-pointer text-xs lg:text-base`}>Townhouse</p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 text-center font-medium">
                                ...
                                <p onClick={() => { placeFriendFunction('None'); onchengeFunction() }} className={`border border-t-0 col-span-2 duration-500 ${placeFriendless.find(p => p == 'None') ? ' border border-[#bab7e4]  hover:bg-[#554db3] bg-[#7065F0] text-white ' : 'bg-white hover:bg-indigo-100'} border-[#7065F0] text-[#7065F0] font-bold py-3 cursor-pointer text-xs lg:text-base `}>None</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 lg:grid-cols-3 text-center font-medium">
                                ...
                                <p onClick={() => { publicAddFunction('None'); onchengeFunction() }} className={`duration-500 border border-s-0 ${publicTransportAccess.find(p => p == 'None') ? 'border border-[#bab7e4] hover:bg-[#554db3] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'} border-[#7065F0] text-[#7065F0] font-bold py-3 cursor-pointer text-xs lg:text-base`}>None</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-10  ">
                        ...
                        <div>
                            ...
                            <div className="mt-4 grid grid-cols-2 lg:grid-cols-3 text-center font-medium">
                                ...
                                <p onClick={() => { occuptionFunction('Backpackers'); onchengeFunction() }} className={` duration-500 border lg:border-t-0 border-s-0 lg:border-s lg:border-e-0 border-b-0 lg:border-b  ${occuption.find(o => o == 'Backpackers') ? 'hover:bg-[#554db3] border border-[#bab7e4] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'} border-[#7065F0] text-[#7065F0] font-bold py-3 cursor-pointer text-xs lg:text-base`}>Backpackers</p>
                                <p onClick={() => { occuptionFunction('On welfare'); onchengeFunction() }} className={` duration-500 border  ${occuption.find(o => o == 'On welfare') ? 'hover:bg-[#554db3] border border-[#bab7e4] bg-[#7065F0] text-white' : 'bg-white hover:bg-indigo-100'} border-[#7065F0] text-[#7065F0] font-bold py-3 cursor-pointer text-xs lg:text-base`}>On welfare</p>
