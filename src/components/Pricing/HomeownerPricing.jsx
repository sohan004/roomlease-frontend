                        ...
                        <div className="flex flex-col lg:flex-row justify-center items-center  gap-8 lg:gap-0 lg:mt-4">
                            ...
                            <div className={` mb-6  duration-500 w-full  bg-white rounded-xl shadow-xl    ${value === 1 ? 'relative scale-110 lg:w-[35%] border-2 z-10  border-[#7065F0]' : 'lg:w-[30%] lg:scale-95'}`}>
                                <div className="text-center p-12">
                                    ...
                                    <div className="flex justify justify-center items-center">
                                        <span className={`duration-300 font-extrabold ${value === 1 ? ' text-5xl lg:text-4xl xl:text-5xl' : 'text-4xl'}  align-text-middle pe-2`}>  $29.99</span>
                                        <span className="font-normal  text-gray-500 inline-block align-text-middle">/  ONE TIME	</span>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div className="text-center p-12">
                                    ...
                                    <div className="flex justify justify-center items-center">
                                        <span className={ `duration-300 font-extrabold ${value === 3 ? ' text-5xl lg:text-4xl xl:text-5xl': 'text-4xl'}  align-text-middle pe-2`}>  $23.99 </span>
