    ...
    return (
        <div className="home bg-white">
            <div className="max-w-[1440px] mx-auto px-4 pt-12">
                <h1 className="text-center text-2xl lg:text-4xl lg:leading-[64px] leading-[44px] mb-8 lg:mb-16 font-extrabold text-blue-950">Smart Choice for Room Rentals</h1>
                <NewSection2 />
            </div>
        </div>
    );
