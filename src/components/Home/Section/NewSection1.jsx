...
const NewSection1 = () => {
    return (
        <div className="home">
            ...
            <h1 style={{'letterSpacing' : '2px', 'lineHeight': '50px'}} className="text-center text-xl lg:text-4xl  mb-8 lg:mb-16 font-extrabold text-blue-950">OUR AI TRANSFORMS SPARE ROOMS INTO INCOME SOURCES, EASES MORTGAGES, AND SIMPLIFIES ACCESS TO OUTDOOR SPACES, BUILDING A HEALTHIER COMMUNITY</h1>
                <NewSection2/>
            </div>
        </div>
    );
