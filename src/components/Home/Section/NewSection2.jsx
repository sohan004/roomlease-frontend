    ...
    return (
        <div className="max-w-[1440px] mx-auto px-4 ">
            ...
            <div className='flex items-center gap-6 justify-center flex-col lg:flex-row lg:gap-3 mt-7'>
                <button className='btn btn-lg w-full lg:w-[450px] hover:bg-[#4e46a1] bg-[#7065F0] text-white text-2xl lg:text-4xl' style={{ height:'100px'}}><FaHome className=''/>List Spare Room </button>
                <button className='btn btn-lg w-full lg:w-[450px] hover:bg-[#4e46a1] bg-[#7065F0] text-white text-2xl lg:text-4xl' style={{ height:'100px'}}><FaBed className=''/>Find Room </button>
            </div>
        </div>
    );
};
