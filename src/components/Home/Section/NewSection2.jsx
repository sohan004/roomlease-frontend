...
const NewSection2 = () => {
    return (
        <div className="max-w-[1440px] mx-auto px-4  lg:my-40 my-20 ">
            ...
            <div className='flex items-center gap-6 justify-center flex-col lg:flex-row lg:gap-3 mt-7'>
                <button className='btn btn-lg w-full lg:w-[350px] hover:bg-[#4e46a1] bg-[#7065F0] text-white '>List Spare Room <FaArrowRight/></button>
                <button className='btn btn-lg w-full lg:w-[350px] hover:bg-[#4e46a1] bg-[#7065F0] text-white '>Find Room <FaArrowRight/></button>
            </div>
        </div>
    );
};
