                ...
                <div className='flex flex-col gap-2 lg:gap-6 lg:flex-row'>
                    ...
                    <div className='w-full lg:w-[30%] '>
                        ...
                        <div className='text-right'>
                            <button disabled={+listingDetails?.user == +userData?.user_id} onClick={sendMessageFunction} className='btn  hover:bg-[#4e46a1] bg-[#7065F0] border-0 text-white w-full capitalize'>send message</button>
                        </div>
                ...
                <div className='flex flex-col gap-6  lg:flex-row mt-6 lg:mt-8'>
                    <div className='w-full lg:w-[70%] '>
                        <div className='grid grid-cols-2 lg:grid-cols-4 border rounded-lg p-6 gap-x-8'>
                            <div>
                                <p className='opacity-70 text-xs lg:text-base  mb-4'>Bedrooms Type</p>
                            ...
                            <div>
                                <p className='opacity-70 text-xs lg:text-base  mb-4'>Private Bathroom</p>
                            ...
                            {listingDetails?.parking_option && <div className=''>
                                <p className='opacity-70 text-xs lg:text-base  mb-4 '>Parking</p>
                            ...
                            {listingDetails?.looking_place && <div className=''>
                                <p className='opacity-70 text-xs lg:text-base  mb-4 '>Looking Place</p>
                            ...
                            <div>
                                <p className='opacity-70 text-xs lg:text-base  mb-4'>Status</p>
                        ...
                        <div className='p-6 bg-[#F7F7FD] border-2 border-[#E0DEF7] rounded-lg'>
                            ...
                            <div className='flex lg:items-center flex-col lg:flex-row gap-y-8 lg:justify-between'>
                                ...
                                <div className='flex lg:items-center gap-4 flex-col lg:flex-row'>
                                    ...
                                    }} className="btn flex-grow lg:flex-grow-0 capitalize border-0 bg-[#E8E6F9] text-[#7065F0]">send message</button>
                            ...
                            return <div key={index} className='flex gap-3 items-start lg:items-center lg:gap-7 border-b pb-4  mb-4'>
                                ...
                                <p className='font-medium opacity-70 lg:w-[100px]'>:</p>
                                {
                                    vlidarray ? <div className='flex items-center w-[128px] lg:w-[300px] flex-wrap gap-2'>
                                        ...
                                        <p className='font-semibold text-xs w-[128px] lg:w-[300px] lg:text-base'>{key == 'home_address' ?
                                            <>
...
export default HomeOwnerListingCardDetails;